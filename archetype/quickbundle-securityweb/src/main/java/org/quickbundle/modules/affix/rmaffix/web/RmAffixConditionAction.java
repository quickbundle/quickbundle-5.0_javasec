//代码生成时,文件路径: E:/platform/myProject/navinfo/code/nifl/src/main/java/org/quickbundle/modules/affix/rmaffix/web/RmAffixConditionAction.java
...
import org.quickbundle.modules.affix.rmaffix.util.RmAffixException;
...
public class RmAffixConditionAction extends RmAffixAction implements IRmAffixConstants {
    ...
    public ActionForward queryAll(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(condition == null) {
            throw new RmAffixException(MESSAGE_NO_CONDITION_KEY);
        }
