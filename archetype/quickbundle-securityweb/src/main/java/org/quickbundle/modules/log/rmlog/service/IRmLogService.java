//代码生成时,文件路径: D:/rc/svn/fm/code/cu-tm/src/main/java/modules/log/rmlog/service/IRmLogService.java
 ...
 * 系统名称:单表模板 --> cu-tm
 * 
 * 文件名称: org.quickbundle.modules.log.rmlog.service --> IRmLogService.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.modules.log.rmlog.service;
...
public interface IRmLogService {
