//代码生成时,文件路径: E:/platform/myProject/navinfo/code/nifl/src/main/java/org/quickbundle/modules/affix/rmaffix/service/IRmAffixService.java
 ...
 * 系统名称:单表模板 --> nifl
 * 
 * 文件名称: org.quickbundle.modules.affix.rmaffix.service --> IRmAffixService.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.modules.affix.rmaffix.service;
...
public interface IRmAffixService {
