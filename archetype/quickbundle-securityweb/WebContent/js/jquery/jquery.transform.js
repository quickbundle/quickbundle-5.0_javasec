...
(function($) { 
	$.transform = function(o) {
		...
		var replaceref = function(val, o) {
			...
			var c = location.protocol == "file:" && /msie/.test(navigator.userAgent.toLowerCase()) ? "\\" : "/";
			...
			if((o.c.xslstr || o.c.xslobj) && (o.c.xmlstr || o.c.xmlobj)) {
				...
				if(/msie/.test(navigator.userAgent.toLowerCase())) {
					...
					try {
						...
						fixref = function(ref,xObj) {
							ref = /firefox/.test(navigator.userAgent.toLowerCase()) && getInternetExplorerVersion().substring(0,3) == "1.9" ? "xsl:" + ref : ref;
