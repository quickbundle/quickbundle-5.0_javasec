...
<%  //处理下载
	if(request.getParameter("downloadSaveName") != null) {
		response.sendRedirect(request.getContextPath() + "/jsp/support/upload/downloadFile_post.jsp?downloadSaveName=" + RmStringHelper.encodeUrl(request.getParameter("downloadSaveName")) + "&downloadRealName=" + RmStringHelper.encodeUrl(request.getParameter("downloadRealName")) + "&fileDir=" + RmStringHelper.encodeUrl(RmUploadHelper.DEFAULT_UPLOAD_DIALOG_DIR));
