...
<%  //取出本条记录
	...
	sh = (RmStatisticHandler)request.getAttribute(IRmAffixConstants.REQUEST_STATISTIC_HANDLER);  //从request中取出RmStatisticHandler, 赋值给sh
%>
<html>
<head>
...
<br>
<h3>统计<%=IRmAffixConstants.TABLE_NAME_CHINESE%></h3>
<table class="table_div_content">
	<tr>
		<td align="right">
			<input type="button" class="button_ellipse" id="button_print"  value="打印" onclick="javascript:print_onClick();" />
			<input type="button" class="button_ellipse" id="button_export" value="导出Excel" onclickto="javascript:exportExcel_onClick();" />
