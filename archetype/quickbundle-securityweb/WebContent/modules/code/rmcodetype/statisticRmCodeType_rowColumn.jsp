...
<%  //取出本条记录
	...
	sh = (RmStatisticHandler)request.getAttribute(IRmCodeTypeConstants.REQUEST_STATISTIC_HANDLER);  //从request中取出RmStatisticHandler, 赋值给sh
%>
<html>
<head>
...
<br>
<h3>统计<%=IRmCodeTypeConstants.TABLE_NAME_CHINESE%></h3>
