...
<table class="mainTable">
	...
	<tr>
		...
		<td colspan="3">
			<input type="text" class="rm_affix" bs_keyword=<%=IRmCodeTypeConstants.TABLE_NAME%> record_id=<%=isModify ? resultVo.getId() : ""%> name="remark2" inputName="备注" value="" maxLength="100" />
		</td>
	</tr>	
	...
	<tr>
		...
		<td colspan="3">
			...
			<textarea class="textarea_fckEditor" bs_keyword=<%=IRmCodeTypeConstants.TABLE_NAME%> record_id=<%=isModify ? resultVo.getId() : ""%> name="remark" inputName="备注" value="" maxLength="100" > </textarea>
		</td>
	</tr>	
</table>
