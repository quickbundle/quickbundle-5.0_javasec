...
<table class="mainTable">
	...
	<tr>
		...
		<td>
			<input type="text" class="text_field_reference" validate='notNull;' hiddenInputId="code_type_id" name="code_type_id_name" inputName="编码类型ID" value="" /><input type="hidden" name="code_type_id"><img class="refButtonClass" src="<%=request.getContextPath()%>/images/09.gif" onClick="javascript:getReference(new Array(form.code_type_id, form.code_type_id_name), '<%=request.getContextPath()%>/', '<%=request.getContextPath()%>/RmCodeTypeAction.do?cmd=queryReference&referenceInputType=radio');"/>
		</td>
		<td align="right"></td>
		<td></td>
	</tr>
