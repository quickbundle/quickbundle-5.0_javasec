...
<%  //取出List
	...
	session.removeAttribute(IRmCodeDataConstants.REQUEST_QUERY_CONDITION);
...
<script type="text/javascript">
	...
	function export_onClick(){  //导出Excel
		form.action="<%=request.getContextPath()%>/modules/code/rmcodedata" + rmJspPath + "/exportRmCodeData_excel.jsp";
...
<table class="table_div_content">
	...
	<%
		...
		m.put("code_type_id", "编码类型ID");
		
		m.put("data_key", "数据关键字");
		
		m.put("enable_status", "启用状态");
		m.put("enable_status_name", "启用状态_name");
				
		m.put("data_value", "数据值");
		
		m.put("total_code", "完整编码");
