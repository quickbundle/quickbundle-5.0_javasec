...
<%
	...
	try {
		if(isSubmit) {
		    ...
		    rtVo = RmExcelHandler.getListDataFromSheet(f, RmUserVo.class.getName(), new RmExcelHandler.IValidateData() {
	...
	if(vo.getLock_status().length() == 0 ) { errorMsg += "Lock_status不能为空;"; }
				
	if(vo.getLogin_id().length() == 0 ) { errorMsg += "Login_id不能为空;"; }
...
<table class="table_div_content">
	...
	<tr>
		...
		<td>
			<a href="#"><u>批量导入<%=IRmUserConstants.TABLE_NAME_CHINESE %>模板</u></a>
		</td>
		<td align="right">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
