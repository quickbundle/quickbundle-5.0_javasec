...
<script type="text/javascript">
	...
	function toAdd_onClick() {  //到增加记录页面
		window.location="<%=request.getContextPath()%>/orgauth/rmauthorizeresource" + rmJspPath + "/insertRmAuthorizeResource.jsp";
	}
...
<layout:collection name="beans" id="rmBean" styleClass="listCss" width="100%" indexId="rmOrderNumber" align="center" sortAction="0">
	...
	<layout:collectionItem width="8%" title='<%=IRmAuthorizeResourceConstants.TABLE_COLUMN_CHINESE.get("authorize_id")%>' property="authorize_id" sortable="true"/>
...
<div id="div_funcNode" style="padding:20px 10px 10px 0px; display:none" align="right">
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/RmAuthorizeResourceConditionAction.do?cmd=queryAll&<%=IRmAuthorizeResourceConstants.DEFAULT_CONDITION_KEY_ARRAY[0]%>=1">带条件模式</a>
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/RmAuthorizeResourceConditionAction.do?cmd=queryAll&<%=IRmAuthorizeResourceConstants.DEFAULT_CONDITION_KEY_ARRAY[0]%>=1&<%=IRmAuthorizeResourceConstants.REQUEST_IS_READ_ONLY%>=1">带条件只读</a>
	</div>
<!-- end -->
