...
<script type="text/javascript">
	...
	function toAdd_onClick() {  //到增加记录页面
		form.action="<%=request.getContextPath()%>/orgauth/rmpartytyperelationrule" + rmJspPath + "/insertRmPartyTypeRelationRule.jsp";
		form.submit();
	}
...
<layout:collection name="beans" id="rmBean" styleClass="listCss" width="100%" indexId="rmOrderNumber" align="center" sortAction="0">
	...
	<layout:collectionItem width="8%" title='<%=IRmPartyTypeRelationRuleConstants.TABLE_COLUMN_CHINESE.get("parent_party_type_id")%>' property="parent_party_type_id_name" sortable="true"/>
	<layout:collectionItem width="8%" title='<%=IRmPartyTypeRelationRuleConstants.TABLE_COLUMN_CHINESE.get("child_party_type_id")%>' property="child_party_type_id_name" sortable="true"/>
...
<%=isReadOnly ? "<input type=\"hidden\" name=\"" + IRmPartyTypeRelationRuleConstants.REQUEST_IS_READ_ONLY + "\" value=\"1\">" : ""%>
