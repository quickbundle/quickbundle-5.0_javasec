...
<table class="mainTable">
	...
	<tr>
		<td align="right"><%=IJobDetailConstants.TABLE_COLUMN_CHINESE.get("job_class_name")%>：</td>
		<td colspan="3"><%=RmStringHelper.prt(resultVo.getJob_class_name())%>&nbsp;</td>
	</tr>
	<tr>
		<td align="right"><%=IJobDetailConstants.TABLE_COLUMN_CHINESE.get("is_durable")%>：</td>
		<td><%=RmGlobalReference.get(IJobDetailConstants.DICTIONARY_RM_YES_NOT, resultVo.getIs_durable())%>&nbsp;</td>
		<td align="right">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td align="right"><%=IJobDetailConstants.TABLE_COLUMN_CHINESE.get("requests_recovery")%>：</td>
		<td><%=RmGlobalReference.get(IJobDetailConstants.DICTIONARY_RM_YES_NOT, resultVo.getRequests_recovery())%>&nbsp;</td>
		<td align="right">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
</table>
...
<input type="hidden" name="id" value="<%=RmStringHelper.prt(resultVo.getJob_name())%>,<%=RmStringHelper.prt(resultVo.getJob_group())%>">
<table align="center">
	<tr>
		<td><br>
