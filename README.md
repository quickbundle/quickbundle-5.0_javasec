...
### 特性
* 以JavaEE标准版(quickbundle-rmwebdemo)为基础 [参考qb-archetype](https://github.com/quickbundle/qb-archetype/blob/master/README.md)<br/>
...
------------------------------------------------
### 特性
* 以phonegap版(quickbundle-phonegapdemo)为基础 [参考qb-archetype](https://github.com/quickbundle/qb-archetype/blob/master/README.md)<br/>
